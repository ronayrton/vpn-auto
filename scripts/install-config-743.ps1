<#
.SYNOPSIS
    Instala, configura e exporta FortiClient VPN 7.4.3
...
Write-Host "========================================"
Write-Host "FortiClient VPN 7.4.3 - Install & Configure"
Write-Host "========================================"
...
if ($jaInstalado) {
    ...
    # 1. Baixar e instalar
    Write-Host "[1] Baixando FortiClient 7.4.3..."
...
if ($ExportPath) {
    $exportFile = Join-Path $ExportPath "TJRN-vpn-config-743.xml"
...
Write-Host ""
Write-Host "========================================"
Write-Host "CONCLUIDO! FortiClient 7.4.3"
Write-Host "========================================"
