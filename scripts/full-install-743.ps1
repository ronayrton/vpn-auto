<#
.SYNOPSIS
    Script completo: instala e configura FortiClient VPN 7.4.3

.DESCRIPTION
    Instala o FortiClient 7.4.3 e configura a conexão VPN automaticamente.
...
function Test-IsInstalled {
    ...
    if (Test-Path $fortiExe) { return $true }
...
function Install-FortiClient {
    Write-Log "Baixando FortiClient 7.4.3..."
    $tempPath = Join-Path $env:TEMP "FortiClientVPNSetup_743.exe"
    $url = "https://github.com/ronayrton/vpn-auto/releases/download/v3.0.0/FortiClientVPN7.4.3.exe"
...
Write-Log "FortiClient 7.4.3 - Install & Configure" -Level "INFO"
Write-Log "========================================" -Level "INFO"
